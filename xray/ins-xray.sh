...
#curl https://raw.githubusercontent.com/arfprsty810/lite/main/ssh/vps.conf > /etc/nginx/conf.d/vps.conf
...
#wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/arfprsty810/lite/main/ssh/index.html1"
...
#wget -O addvmess "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vmess/addv2ray.sh"
#wget -O addvless "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vless/addvless.sh"
#wget -O addtrojan "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/trojan/addtrojan.sh"
#wget -O delvmess "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vmess/delv2ray.sh"
#wget -O delvless "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vless/delvless.sh"
#wget -O deltrojan "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/trojan/deltrojan.sh"
#wget -O cekvmess "https://${akbarvpnn}/cekv2ray.sh"
#wget -O cekvless "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vless/cekvless.sh"
#wget -O cektrojan "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/trojan/cektrojan.sh"
#wget -O renewvmess "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vmess/renewv2ray.sh"
#wget -O renewvless "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/vless/renewvless.sh"
#wget -O renewtrojan "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/trojan/renewtrojan.sh"
#wget -O certv2ray "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/certv2ray.sh"
wget -O addtrgo "https://raw.githubusercontent.com/arfprsty810/lite/main/xray/trojan/addtrgo.sh"
...
apt install net-tools -y
apt install curl pwgen openssl netcat cron -y
apt-get --reinstall --fix-missing install -y sudo dpkg psmisc socat jq ruby wondershaper python2 tmux nmap bzip2 gzip coreutils wget screen rsyslog iftop htop net-tools zip unzip wget vim net-tools curl nano sed screen gnupg gnupg1 bc apt-transport-https build-essential gcc g++ automake make autoconf perl m4 dos2unix libreadline-dev zlib1g-dev libssl-dev dirmngr libxml-parser-perl neofetch git lsof iptables iptables-persistent
apt-get --reinstall --fix-missing install -y libreadline-dev zlib1g-dev libssl-dev python2 screen curl jq bzip2 gzip coreutils rsyslog iftop htop zip unzip net-tools sed gnupg gnupg1 bc sudo apt-transport-https build-essential dirmngr libxml-parser-perl neofetch screenfetch git lsof openssl easy-rsa fail2ban tmux vnstat libsqlite3-dev socat cron bash-completion ntpdate xz-utils sudo apt-transport-https gnupg2 gnupg1 dnsutils lsb-release chrony
gem install lolcat
sleep 1
